...
namespace QLTVLite
{
    public partial class WDBookDisplay : Window
    {
        public WDBookDisplayViewModel ViewModel { get; set; }

        public WDBookDisplay()
        {
            InitializeComponent();
            ViewModel = new WDBookDisplayViewModel();
            DataContext = ViewModel; // Đặt DataContext cho ViewModel
        }
    }

    public class WDBookDisplayViewModel : INotifyPropertyChanged
    {
        ...
        public int CurrentPage
        {
            ...
            set
            {
                if (_currentPage != value)
                {
                    ...
                    DisplayBooks(); // Cập nhật danh sách sách mỗi khi thay đổi trang
                }
            }
        }
